...
KAM_LOG=${KAM_LOG:-"/ngcp-data/logs/kamailio-proxy.log"}
KAMLB_LOG=${KAMLB_LOG:-"/ngcp-data/logs/kamailio-lb.log"}
SEMS_LOG=${SEMS_LOG:-"/ngcp-data/logs/sems.log"}
SEMS_PBX_LOG=${SEMS_PBX_LOG:-"/ngcp-data/logs/sems-pbx.log"}
